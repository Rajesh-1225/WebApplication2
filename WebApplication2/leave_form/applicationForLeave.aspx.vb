...
#End Region
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim con1 As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
        con1.Open()
        ...
        While reader2.Read()
            If Session("dept") = "MECHANICAL" Then
                ...
                Dim conn1 As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
                conn1.Open()
                Dim j As Integer
        ...
        Try
            ...
            Dim conc As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
            conc.Open()
        ...
        Dim connc As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
        connc.Open()
        ...
        Dim conn As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
        conn.Open()
...
")
    ...
    Protected Sub cal1_SelectionChanged(sender As Object, e As EventArgs) Handles cal1.SelectionChanged
        ...
        If ddlleave_code.SelectedItem.Value = "17" Then
            Dim startDate1 As String = txtleave_from.Text
            Dim startdate As DateTime = Convert.ToDateTime(startDate1)
            Dim conn2 As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
            conn2.Open()
            Dim j2 As Integer
    ...
    Protected Sub Btndoc_Click(sender As Object, e As EventArgs) Handles btndoc.Click
        ...
        If fileExtension.ToLower() = ".jpg" Or fileExtension.ToLower() = ".gif" Or fileExtension.ToLower() = ".png" Or fileExtension.ToLower() = ".bmp" Or fileExtension.ToLower() = ".txt" Or fileExtension.ToLower() = ".docx" Then
            ...
            Using conn As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")

...
#End Region
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        If rblList.SelectedItem.Value = "MasterCalibrationPlan" Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=40675&user0=crissqlserver&password0=Cris@BelaQwertPoiuy"
            'strPathName = strPathName & ""
            Response.Redirect(strPathName)
        ElseIf rblList.SelectedItem.Value = "MasterCalibrationList" Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=40824&user0=crissqlserver&password0=Cris@BelaQwertPoiuy"
            'strPathName = strPathName & ""
            Response.Redirect(strPathName)
        ElseIf rblList.SelectedItem.Value = "ToolMaster" Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=40451&user0=crissqlserver&password0=Cris@BelaQwertPoiuy"
            'strPathName = strPathName & ""
            Response.Redirect(strPathName)
        ...
        ElseIf rblList.SelectedItem.Value = "CalibrationOverDue" Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=40712&user0=crissqlserver&password0=Cris@BelaQwertPoiuy"
            'strPathName = strPathName & ""
            Response.Redirect(strPathName)
        ElseIf rblList.SelectedItem.Value = "LocationWiseTools" Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=40665&user0=crissqlserver&password0=Cris@BelaQwertPoiuy"
            'strPathName = strPathName & ""
            Response.Redirect(strPathName)
        Else

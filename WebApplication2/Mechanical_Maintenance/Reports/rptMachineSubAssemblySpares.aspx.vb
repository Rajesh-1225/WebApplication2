...
#End Region
    ...
    Private Sub btnShowReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShowReport.Click
        ...
        If rblStockType.SelectedIndex = 0 Then
            If cboLocation.SelectedItem.Text.Trim.ToUpper = "ALL" Then
                If ddlMachineCode.SelectedItem.Text.Trim.ToUpper = "ALL" Then
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=33086&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
      ...
      lblGrp.Text.Trim & "&prompt1=" & ddlMachineCode.SelectedItem.Value.Trim & "&promptonrefresh=0"
        ...
        Else
            If cboLocation.SelectedItem.Text.Trim.ToUpper = "ALL" Then
                If ddlMachineCode.SelectedItem.Text.Trim.ToUpper = "ALL" Then
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=33107&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
     lblGrp.Text.Trim & "&prompt1=ALL&promptonrefresh=0"
                Else
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=33107&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
      lblGrp.Text.Trim & "&prompt1=" & ddlMachineCode.SelectedItem.Value.Trim & "&promptonrefresh=0"
    ...
    Private Sub btnPLReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPLReport.Click
        ...
        End If
        If ddlMachineCode.SelectedItem.Text.Trim.ToUpper = "ALL" Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=33100&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0&prompt0=" & lblGrp.Text.Trim & "&prompt1=ALL&promptonrefresh=0"
        Else
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=33100&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&prompt0=" & lblGrp.Text.Trim & "&prompt1=" & ddlMachineCode.SelectedItem.Value.Trim & "&promptonrefresh=0"
        End If
    ...
    Private Sub btnReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        If rblPlDesc.SelectedItem.Text.StartsWith("Com") Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=18320&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&prompt0=" & lblGrp.Text.Trim & "&prompt1=" & ddlMachine.SelectedItem.Value.Trim & "&prompt2=A&promptonrefresh=0"
            Response.Redirect(strPathName)
        Else
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=18327&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&prompt0=" & lblGrp.Text.Trim & "&prompt1=" & ddlMachine.SelectedItem.Value.Trim & "&prompt2=" & rblPlDesc.SelectedItem.Value.Trim & "&promptonrefresh=0"
            Response.Redirect(strPathName)
        End If
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=27890&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0&prompt0=" & lblGrp.Text.Trim & "&prompt1=AAA&promptonrefresh=0"
        Response.Redirect(strPathName)
    End Sub
End Class

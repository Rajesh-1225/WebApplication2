...
#End Region
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=41054&user0=crissqlserver&password0=Cris@BelaQwertPoiuy"
    ...
    Private Sub btnSelected_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelected.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=40198&user0=crissqlserver&password0=Cris@BelaQwertPoiuy"
        strPathName &= "&prompt0= DateTime(" & CStr(CDate(dt).Year) & "," & CStr(CDate(dt).Month) & "," & CStr(CDate(dt).Day) & ", 0,0,0)"
        strPathName &= "&prompt1= DateTime(" & CStr(CDate(dt1).Year) & "," & CStr(CDate(dt1).Month) & "," & CStr(CDate(dt1).Day) & ", 0,0,0)"

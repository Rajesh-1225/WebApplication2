...
#End Region
    ...
    Private Sub GetGridData()
        ...
        Try
            ...
            If RadioButtonList1.SelectedItem.Value = "LPG" Then
                strArg = "select * from ms_HSDValues where  ItemDate='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "'and Item='" & rblArea.SelectedItem.Value & "'"
            ElseIf RadioButtonList1.SelectedItem.Value = "BMCG" Then
                strArg = "select * from ms_HSDValues where  ItemDate='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "'and Item='" & RadioButtonList2.SelectedItem.Value & "'"
            End If
            objCmd = New SqlCommand(strArg, con)

            objDr = objCmd.ExecuteReader()
            Dim arr() As String
            dgSavedData.DataSource = arr
            dgSavedData.DataBind()
            dgSavedData.DataSource = objDr
            dgSavedData.DataBind()
    ...
    Protected Sub dgSavedData_SelectedIndexChanged(sender As Object, e As EventArgs) Handles dgSavedData.SelectedIndexChanged
        Dim i As String
        dgSavedData.SelectedIndex = i
        txtDate.Text = Trim(dgSavedData.Items(i).Cells(1).Text)
        If RadioButtonList1.SelectedItem.Text = "LPG" Then
            rblArea.SelectedItem.Value = Trim(dgSavedData.Items(i).Cells(2).Text)

        Else
            RadioButtonList2.SelectedItem.Value = Trim(dgSavedData.Items(i).Cells(2).Text)
        End If
        txtValue.Text = dgSavedData.Items(i).Cells(3).Text

        txtRemarks.Text = dgSavedData.Items(i).Cells(4).Text
        txtChallanDate.Text = dgSavedData.Items(i).Cells(6).Text
        txtChallanNumber.Text = dgSavedData.Items(i).Cells(5).Text
    End Sub
    ...
    '    da.SelectCommand.Parameters.Add("@dt", SqlDbType.SmallDateTime, 4).Value = Format(CDate(txtDate.Text), "MM/dd/yyyy")
    '    If RadioButtonList1.SelectedValue = "LPG" Then
    ...
    Private Sub GetValue()
        ...
        ElseIf RadioButtonList2.SelectedItem.Value = "BMCG" Then
            da.SelectCommand.Parameters.Add("@Item", SqlDbType.VarChar, 50).Value = RadioButtonList2.SelectedItem.Value
        End If
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            End If
            oCmd.Parameters.Add("@ChallanNumber", SqlDbType.VarChar, 20).Value = txtChallanNumber.Text

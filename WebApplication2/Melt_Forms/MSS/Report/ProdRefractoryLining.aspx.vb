...
#End Region
    ...
    Private Sub btnFWP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFWP.Click
        ...
        If Not Done Then
            ...
            Select Case rblFWPType.SelectedItem.Value
                Case 1
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=24864&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    ...
    Private Sub btnLiningNo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLiningNo.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=16401&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    ...
    Private Sub btnlLiningNo3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlLiningNo3.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=16724&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    ...
    Private Sub btnLRL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLRL.Click
        ...
        If Not Done Then
            ...
            Select Case rblFWPType.SelectedItem.Value
                Case 1
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=13656&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
                    "&prompt0=DateTime(" & CDate(txtFrDt.Text).Year & "," & CDate(txtFrDt.Text).Month & "," & CDate(txtFrDt.Text).Day & ", 0,0,0)" &
                    "&prompt1=DateTime(" & CDate(txtToDt.Text).Year & "," & CDate(txtToDt.Text).Month & "," & CDate(txtToDt.Text).Day & ", 0,0,0)" &
    ...
    Private Sub btnPONo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPONo.Click
        ...
        If PO = 1 OrElse PO = 2 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=24874&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
            "&prompt0=" & rblLiningType.SelectedItem.Value & "" &
            "&prompt1=" & ddlPONo.SelectedItem.Value & "" &
            "&prompt2=0"
        ElseIf PO = 3 OrElse PO = 4 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=34165&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
            "&prompt0=" & rblLiningType.SelectedItem.Value & "" &
            "&prompt1=" & ddlPONo.SelectedItem.Value & "" &
            "&prompt2=0" &
            "&user0@SubReport1.rpt=report&password0@SubReport1.rpt=report"
    ...
    Private Sub btnRRL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRRL.Click
        ...
        If Not Done Then
            ...
            Select Case rblFWPType.SelectedItem.Value
                Case 1
                    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=16739&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
                    "&prompt0=DateTime(" & CDate(txtFrDt.Text).Year & "," & CDate(txtFrDt.Text).Month & "," & CDate(txtFrDt.Text).Day & ", 0,0,0)" &
                    "&prompt1=DateTime(" & CDate(txtToDt.Text).Year & "," & CDate(txtToDt.Text).Month & "," & CDate(txtToDt.Text).Day & ", 0,0,0)" &
    ...
    Private Sub btnLOANo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLOANo.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=34399&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &

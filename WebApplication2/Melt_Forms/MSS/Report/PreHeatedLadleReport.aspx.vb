...
#End Region
    ...
    Private Sub btnDetails_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetails.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=34151&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    ...
    Private Sub btnlLining_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlLining.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=24845&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
        "&promptex0=DateTime(" & CDate(txtFrDt.Text).Year & "," & CDate(txtFrDt.Text).Month & "," & CDate(txtFrDt.Text).Day & " 0,0,0)" &
        "&promptex1=DateTime(" & CDate(txtToDt.Text).Year & "," & CDate(txtToDt.Text).Month & "," & CDate(txtToDt.Text).Day & " 0,0,0)" &

Public Class BHNSampleReport
    ...
    Protected Sub btnBHNSample_Click(sender As Object, e As EventArgs) Handles btnBHNSample.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=14621&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &

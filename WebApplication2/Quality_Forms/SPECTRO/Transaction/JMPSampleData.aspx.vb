...
Public Class JMPSampledata
    ...
    Public Function update()
        ...
        'Dim txt_time As String = Format(CDate(txttime.Text))
        ...
        cmd.CommandText = ("update mm_spectro_results_new Set carbon=@txt_c,manganese=@txt_mn,silicon=@txt_si,phosphorus=@txt_p,sulphur=@txt_s,chromium=@txt_cr,nickle=@txt_ni,copper=@txt_cu,molybdenum=@txt_mo,vanadium=@txt_v,alunimum=@txt_al,nitrogen=@txt_n,hydrogen=@txt_h,nicrmo=@txt_cnm where date =@txt_date and shift=@txt_shift and heatnumber=@HeatNo and sampletype=@txt_sampetype")

        cmd.Parameters.AddWithValue("@HeatNo", txtheat.Text)

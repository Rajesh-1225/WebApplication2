<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Magna_Dashboard_29_MAY_2020.aspx.vb" Inherits="WebApplication2.Magna_Dashboard_29_MAY_2020" %>
...
<head runat="server">
 ...
 <link rel="stylesheet" href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css">
    ...
    <title>Magna Dashboard 29 MAY 2020 </title>
    <style>
           ...
           <div class="col-sm-3">
                 <div align="center">
                        ...
                        <form id="form1" runat="server">
                         ...
                         <asp:DropDownList ID="Fin_Year" runat="server" CssClass="font-weight-bold btn btn-primary">
                         </asp:DropDownList>
                            <br />
                            <br />

                         <asp:DropDownList ID="Prod" runat="server" CssClass="font-weight-bold btn btn-primary">
                         </asp:DropDownList>
                            <br />
                            <br />
                         <asp:DropDownList ID="Report_Type" runat="server" CssClass="font-weight-bold btn btn-primary" Width="285px">
                         </asp:DropDownList>
                        ...
                        <asp:Button ID="btnSubmit" runat="server" Text="VIEW" CssClass="font-weight-bold btn btn-primary" />
                ...
                <button type="button" class="font-weight-bold btn btn-primary mb-2" data-toggle="modal" data-target="#myChartModal">View Data</button>
                      ...
                      <%--<h6 style="font-weight: bold;"><a href="#" id="downloadPdf" onclick="printDiv()" ></a></h6>  --%>
                      <br />
                            <br />

                      <a class="btn btn-primary font-weight-bold mb-2" style="color:white" id="downloadPdf" onclick="printDiv()">Export PDF</a>
             ...
             <div class="col-sm-9" id="printThis" align="center">
  ...
  <div class="modal fade" id="myChartModal" role="dialog">
    <div class="modal-dialog modal-lg">
     ...
     <%-- <div class="modal-header">
         ...
         <h4 class="modal-title" align="center"><b><i>View Data</i></b></h4>
        </div>--%>

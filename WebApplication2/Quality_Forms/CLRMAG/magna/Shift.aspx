<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Shift.aspx.vb" Inherits="WebApplication2.Shift"  Culture = "en-GB" %>%>
    ...
    return date;
         ...
         <div class="container">
             ...
             <asp:Panel id="Panel1" runat="server">
				...
				<div class="table">
					<div class="row">
						<div class="col" align="center" ><h2><b> <center>Shift Report</h2></b></center></div>
					</div>
                    </div>
                 ...
                 <div class="row">
						...
						<div class="col">
                            ...
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Wrong Date" ControlToCompare="txtfromDate" ControlToValidate="TextToDate" Operator="GreaterThan" ToolTip="Wrong Date" ValidationGroup="a" Type="Date"></asp:CompareValidator></div>

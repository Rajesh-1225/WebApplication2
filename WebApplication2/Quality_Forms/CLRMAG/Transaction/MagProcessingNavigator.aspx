...
<!--/.Navbar -->
            ...
            <table class="table">
               ...
               <br />
                <div class="row">
                    ...
                    <div class="col"><asp:TextBox ID="txtuid" runat="server" Width="150px" CssClass="form-control" onkeypress="isInputNumber(event)"></asp:TextBox></div>
                ...
                <br />
                 <div class="row">
                    ...
                    <div class="col"><asp:TextBox ID="txtuidd" runat="server"  Width="150px" CssClass="form-control" onkeypress="isInputNumber(event)"></asp:TextBox></div>
                    <div class="col">Password*</div>
   ...
   <asp:panel ID="panel2" runat="server">
       ...
       <div class="table">
                ...
                <div class="col"><asp:RadioButtonList ID="RBLProductType" runat="server" AutoPostBack="True" RepeatLayout="Flow" RepeatDirection="Horizontal" CssClass="rbl">
                        <asp:ListItem Value="BGC">BGC</asp:ListItem>
                ...
                <br />
                 <div class="row">
                      ...
                      <div class="col"><asp:DropDownList ID="ddline" runat="server" AutoPostBack="True" CssClass="form-control ll" Width="120px">
                ...
                <div class="row">
                    ...
                    <div class="col"><asp:TextBox ID="txtutbatch" runat="server" Width="120px" CssClass="form-control" MaxLength="15" TabIndex="1"></asp:TextBox></div>
                ...
                <div class="row">
                    ...
                    <div class="col"><asp:TextBox ID="txtheat" runat="server" CssClass="form-control" Width="120px" onkeypress="isInputNumber(event)" MaxLength="4" TabIndex="3"></asp:TextBox></div>
                    <div class="col">Mould Number*</div>
                    <div class="col"><asp:TextBox ID="txtwheel" runat="server" AutoPostBack="true" Width="120px" CssClass="form-control" onkeypress="isInputNumber(event)" MaxLength="3" TabIndex="4"></asp:TextBox></div>
            ...
            <div class="table">
               <div class="row">
                    ...
                    <div class="col"><asp:TextBox ID="txtbhnone" runat="server" CssClass="form-control" MaxLength="3" onkeypress="isInputNumber(event)" Width="100px" TabIndex="5"></asp:TextBox> </div>
               ...
               <div class="col">Wheel Type*</div>
                 ...
                 <div class="row">
                    <asp:Panel runat="server" ID="Panel8" >
                     ...
                     <div class="col"><asp:TextBox ID="TxtWFPSdone" runat="server" CssClass="form-control" Width="120px" MaxLength="20" TabIndex="7"></asp:TextBox> </div>
                    </asp:Panel> 
                    <div class="col">Mag Boom A.Current </div>
                    <div class="col"><asp:TextBox ID="txtamm" runat="server" CssClass="form-control" Width="100px" MaxLength="3" onkeypress="isInputNumber(event)" TabIndex="8">107</asp:TextBox></div>
                    <div class="col">Defect Code <asp:Label ID="lblHelp" runat="server">Help(?)</asp:Label>   
                     ...
                     <div class="col"><asp:TextBox ID="TxtDefectCode" runat="server" CssClass="form-control" Width="120px" MaxLength="30" TabIndex="9"></asp:TextBox></div>
              ...
              <div class="row">
                   ...
                   <div class="col"><asp:DropDownList ID="DDDefTNull" runat="server" AutoPostBack="true" CssClass="form-control ll" Width="100px">
                        <asp:ListItem Value="OK" Selected="True">OK</asp:ListItem>
                    ...
                    <asp:Panel runat="server" ID="Panel5" >
                     <div class="col"> <asp:TextBox ID="TxtMachining" runat="server"  AutoPostBack="true" placeholder="Enter Remarks" CssClass="form-control" MaxLength="15" Width="120px"></asp:TextBox> </div>
                    </asp:Panel> 
                    <asp:Panel runat="server" ID="Panel6" >
                    <div class="col"> <asp:TextBox ID="TxtGrinding" runat="server" AutoPostBack="true" placeholder="Enter Remarks" CssClass="form-control" MaxLength="15" Width="120px"></asp:TextBox> </div>
                    </asp:Panel>
                   <asp:Panel runat="server" ID="Panel7" >
                    <div class="col"> <asp:TextBox ID="TxtXCcodes" runat="server" AutoPostBack="true" placeholder="XCCODES" CssClass="form-control" MaxLength="20" Width="120px" TabIndex="11"></asp:TextBox>  </div>
                    </asp:Panel> 
                    <div class="col">UT Wheel No</div>
                    <div class="col"><asp:TextBox ID="txtutwheel" runat="server" CssClass="form-control" MaxLength="4" Width="120px" onkeypress="isInputNumber(event)" TabIndex="12"></asp:TextBox></div>
                  <div class="col">UT Status*</div>
                    ...
                    <div class="col"><asp:TextBox ID="TxtUTDefectCode" runat="server" Width="120px" CssClass="form-control" MaxLength="20" TabIndex="14"></asp:TextBox></div>
                     </asp:Panel>
                     </div> 
                 <br />                             
                             <div class="row">
                     <div class="col">Final Status</div>
                <div class="col"><asp:TextBox ID="txtFinalstatus" runat="server" CssClass="form-control" Width="120px" ></asp:TextBox></div>
    ...
    <asp:ButtonColumn Text="Select" HeaderText="Select" CommandName="Select"></asp:ButtonColumn>
     <asp:BoundColumn DataField="Magid" HeaderText="SrNo"></asp:BoundColumn>

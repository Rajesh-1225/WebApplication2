...
#End Region
    ...
    Public Class MLDING
        ...
        Public Function WheelNFLoading1(ByVal loading_date As Date, ByVal shift_code As String, ByVal operator_code As String, ByVal supervisor As String,
                                        ByVal wheel_number As Integer, ByVal heat_number As Long, ByVal wheel_sr_no As String, ByVal Cold As Int16, ByVal pour_order As String, ByVal srbit As Integer, PType As String, Optional ByVal Sl_No As Long = 0) As Boolean
            ...
            cmd.Parameters.Add("@pour_order", SqlDbType.VarChar, 4).Value = pour_order
            cmd.Parameters.Add("@srbit", SqlDbType.Int, 4).Value = srbit
            cmd.Parameters.Add("@PType", SqlDbType.VarChar, 10).Value = PType
            ...
            Try
                ...
                If IIf(IsDBNull(cmd.Parameters("@Sl_No").Value), 0, cmd.Parameters("@Sl_No").Value) = 0 Then
                    cmd.CommandText = " insert into mm_nf_loading ( loading_date , shift_code , " &
                        " operator_code , supervisor , wheel_number , heat_number , wheel_sr_no, Cold ,pour_order,srbit,PType)" &
                        " values ( @loading_date , @shift_code , @operator_code , @supervisor , @wheel_number , " &
                        " @heat_number , @wheel_sr_no , @Cold, @pour_order,@srbit,@PType) "
                Else
                    cmd.CommandText = "update mm_nf_loading set" &
                    " operator_code = @operator_code , supervisor = @supervisor , " &
                    " wheel_number = @wheel_number,Cold = @Cold ,PType=@PType,heat_number = @heat_number" &
                    " where loading_date = @loading_date and shift_code = @shift_code and" &
                    " wheel_sr_no =@wheel_sr_no and srbit =@srbit and Sl_No = @Sl_No "
        ...
        Public Shared Function MouldTransShiftData(ByVal TransDt As Date, ByVal Sh As String) As DataSet
            ...
            Try
                da.SelectCommand.CommandText = "select row_number() over ( order by SlNo  ) Sl , " &
                    ...
                    " from mm_MouldTransactionNew a inner join mm_MouldTransactionType b on a.TransType = b.TransNo " &

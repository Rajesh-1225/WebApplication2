...
Public Class User_Password_change
    ...
    Protected Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        con.Open()
        Dim s As String = "select employee_name,password from MENU_YOUR_PASSWORD_NEW where employee_code='" & Session("Ecode") & "'"
    ...
    Sub modify()
        Dim con As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
        con.Open()
        Dim updatestr As String = "update MENU_YOUR_PASSWORD_NEW set password='" & txtnew_pswd.Text & "' where employee_code='" & Session("Ecode") & "'"
    ...
    Protected Sub txtEmployee_Code_TextChanged(sender As Object, e As EventArgs) Handles txtemployee_code.TextChanged
        ...
        Dim con As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
        con.Open()
        Dim s As String = "select employee_name from MENU_YOUR_PASSWORD_NEW where employee_code='" & Session("Ecode") & "'"
        rdr = SqlHelper.ExecuteReader(con, CommandType.Text, s)
        While rdr.Read
            lblname.Text = rdr.Item("employee_name")
        End While

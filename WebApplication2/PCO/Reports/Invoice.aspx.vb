    ...
    Private Sub btnShowReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShowReport.Click
        If btnShowReport.Text.StartsWith("Show") Then
            ...
            If rblGroup.SelectedIndex = 0 Then
                strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=25805&apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &

...
#End Region
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        If PCO.tables.WorkorderCount(Right(rblYear.SelectedItem.Text, 1) + rblMonth.SelectedItem.Value) > 0 Then
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=40403&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &
                "&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&prompt1=" & rblYear.SelectedItem.Value + rblMonth.SelectedItem.Value & "&prompt0=" & rblMonth.SelectedItem.Text.ToUpper & ", " & rblYear.SelectedItem.Text & "" &
                "&user0@SubReport.rpt=crissqlserver&password0@SubReport.rpt=Cris@BelaQwertPoiuy"
    ...
    Private Sub btnForAppr_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnForAppr.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=8265&apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &

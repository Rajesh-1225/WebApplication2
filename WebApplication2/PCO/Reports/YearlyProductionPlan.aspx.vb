...
#End Region
    ...
    Private Sub btnRWFTargetReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRWFTargetReport.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=39025&apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &
    ...
    Private Sub btnRBTargetReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRBTargetReport.Click
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=34362&apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &
                    "&prompt0=" & ddlFinYear.SelectedItem.Text
        Response.Redirect(strPathName, True)
    End Sub
End Class

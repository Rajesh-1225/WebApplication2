...
#End Region
    ...
    Private Sub ShowReport()
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=25560&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=15947&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    ...
    '    Dim strPathName As String
    '    strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=13875&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    '        "&prompt0=DateTime(" & CStr(CDate(txtPHLDate.Text).Year) & "," & CStr(CDate(txtPHLDate.Text).Month) & "," & CStr(CDate(txtPHLDate.Text).Day) & ", 00, 00, 00)"
    '    Response.Redirect(strPathName)
    'End Sub
    ...
    Private Sub btnCWEW_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCWEW.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=25753&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
            "&prompt0=DateTime(" & CStr(CDate(txtPHLDate.Text).Year) & "," & CStr(CDate(txtPHLDate.Text).Month) & "," & CStr(CDate(txtPHLDate.Text).Day) & ", 00, 00, 00)" &
            "&user0@RBTargets.rpt=sa&password0@RBTargets.rpt=sa" &
            "&user0@Summary.rpt=sa&password0@Summary.rpt=sa" &
            "&user0@mm_GMHeat.rpt=sa&password0@mm_GMHeat.rpt=sa" &
    ...
    Private Sub btnCWEA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCWEA.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=25526&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
            "&prompt0=DateTime(" & CStr(CDate(txtPHLDate.Text).Year) & "," & CStr(CDate(txtPHLDate.Text).Month) & "," & CStr(CDate(txtPHLDate.Text).Day) & ", 00, 00, 00)" &
            "&user0@RBTargets.rpt=sa&password0@RBTargets.rpt=sa" &
            "&user0@Summary.rpt=sa&password0@Summary.rpt=sa" &
            "&user0@mm_GMHeat.rpt=sa&password0@mm_GMHeat.rpt=sa" &
    ...
    Private Sub btnMag_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMag.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=27474&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        Dim strPathName As String
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=25547&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
            "&prompt0=DateTime(" & CStr(CDate(txtPHLDate.Text).Year) & "," & CStr(CDate(txtPHLDate.Text).Month) & "," & CStr(CDate(txtPHLDate.Text).Day) & ", 00, 00, 00)"
        Response.Redirect(strPathName)
    End Sub
End Class

...
#End Region
    ...
    Private Sub printReport()
        ...
        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=41333&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
                    "&user0@MRSPopulationOfDRAGs.rpt=crissqlserver&password0@MRSPopulationOfDRAGs.rpt=Cris@BelaQwertPoiuy&user0@MRSPopulationOfDragIngates.rpt=crissqlserver&password0@MRSPopulationOfDragIngates.rpt=Cris@BelaQwertPoiuy&user0@MRSPopulationOfDragGraphiteAvailable.rpt=crissqlserver&password0@MRSPopulationOfDragGraphiteAvailable.rpt=Cris@BelaQwertPoiuy"

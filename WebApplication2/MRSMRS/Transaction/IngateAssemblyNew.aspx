 ...
 <div class="table">
			...
			<asp:panel id="Panel1"  runat="server" >
								...
								<div class="row">
									...
									<div class="col" >
										<asp:textbox id="txtMouldNumber" runat="server" CssClass="auto-style5" AutoPostBack="True" MaxLength="5" ToolTip="enter drag number(only numeric)" onkeypress="OnlyNumericEntry()" Width="103px"></asp:textbox></div>
								</div><br />
								<div class="row">

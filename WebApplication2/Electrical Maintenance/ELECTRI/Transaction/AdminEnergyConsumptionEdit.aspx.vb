...
Public Class AdminEnergyConsumptionEdit
    ...
    Private Sub btnSubmit_Clicks_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSubmit_Clicks.Click
        ...
        Try
            ...
            If lblMode.Text.ToLower = "edit" Then
                oAdmn.SaveAdminEnergyConsumption(CDate("1900-01-01"), True)
            Else
                oAdmn.SaveAdminEnergyConsumption(CDate(txtDate.Text), True)
            End If
    ...
    '    da.SelectCommand.CommandText = "select * from  ms_admin_energy_consumption where consumption_date = @consumption_date"
    '    da.SelectCommand.Parameters.Add(New SqlClient.SqlParameter("@consumption_date", SqlDbType.SmallDateTime, 4)).Value = CDate(txtDate.Text)
    '    Dim rdr As SqlClient.SqlDataReader
    '    da.SelectCommand.Connection.Open()
    '    rdr = da.SelectCommand.ExecuteReader
    '    Dim dt As DataTable
    '    If rdr.Read Then
    '        txtKPTCL_initial.Text = IIf(IsDBNull(dt.Rows(0)("kptcl_initial")), "", dt.Rows(0)("kptcl_initial"))
    '        txtKPTCL_final.Text = dt.Rows(0)("kptcl_final")
    '        txtDGGenI_final.Text = rdr("dg_gen1_initial")
    '        txtDGGenI_initial.Text = rdr("dg_gen1_final")
    '        txtArc1_initial.Text = rdr("arc1_initial")
    '        txtArc1_final.Text = rdr("arc1_final")
    '        'txtAdmin_initial.Text = rdr("SofteningHrs")
    '        'lblTotQty.Text = rdr("Total_Qty")
    '        'txtKPTCL_initial.Text = rdr("ktpcl_initial")
    '        'txtKPTCL_final.Text = rdr("ktpcl_final")
    ...
    Private Sub GetGridData()
        ...
        Dim con As New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=WAP;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
        ...
        Try
            ...
            strArg = "select * from  ms_admin_energy_consumption where consumption_date ='" & Format(CDate(txtDate.Text), "MM/dd/yyyy") & "'"
    ...
    Protected Sub datagrid1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DataGrid1.SelectedIndexChanged
        ...
        txtDate.Text = DataGrid1.Items(i).Cells(1).Text
        txtDGGenI_initial.Text = Trim(DataGrid1.Items(i).Cells(2).Text)
        txtDGGenI_final.Text = DataGrid1.Items(i).Cells(3).Text
        txtKPTCL_initial.Text = Trim(DataGrid1.Items(i).Cells(4).Text)
        txtKPTCL_final.Text = DataGrid1.Items(i).Cells(5).Text
        txtArc1_initial.Text = Trim(DataGrid1.Items(i).Cells(6).Text)
        txtArc1_final.Text = DataGrid1.Items(i).Cells(7).Text
        txtArc2_initial.Text = Trim(DataGrid1.Items(i).Cells(8).Text)
        txtArc2_final.Text = DataGrid1.Items(i).Cells(9).Text
        txtArc3_initial.Text = Trim(DataGrid1.Items(i).Cells(10).Text)
        txtArc3_final.Text = DataGrid1.Items(i).Cells(11).Text
        txtPump_initial.Text = Trim(DataGrid1.Items(i).Cells(12).Text)
        txtPump_final.Text = DataGrid1.Items(i).Cells(13).Text
        MeltESS_initial.Text = Trim(DataGrid1.Items(i).Cells(14).Text)
        MeltESS_final.Text = DataGrid1.Items(i).Cells(15).Text
        TubePHESS_initial.Text = Trim(DataGrid1.Items(i).Cells(16).Text)
        TubePHESS_final.Text = DataGrid1.Items(i).Cells(17).Text
        MouldPHESS_initial.Text = Trim(DataGrid1.Items(i).Cells(18).Text)
        MouldPHESS_final.Text = DataGrid1.Items(i).Cells(19).Text
        FumePHESS_initial.Text = Trim(DataGrid1.Items(i).Cells(20).Text)
        FumePHESS_final.Text = DataGrid1.Items(i).Cells(21).Text
        txtSubstation_initial.Text = Trim(DataGrid1.Items(i).Cells(22).Text)
        txtSubstation_final.Text = DataGrid1.Items(i).Cells(23).Text
        txtColony12_initial.Text = Trim(DataGrid1.Items(i).Cells(24).Text)
        txtColony12_final.Text = DataGrid1.Items(i).Cells(25).Text
        txtColony34_initial.Text = Trim(DataGrid1.Items(i).Cells(26).Text)
        txtColony34_final.Text = DataGrid1.Items(i).Cells(27).Text
        txtAdmin_initial.Text = Trim(DataGrid1.Items(i).Cells(28).Text)
        txtAdmin_final.Text = DataGrid1.Items(i).Cells(29).Text
        txtAux_initial.Text = Trim(DataGrid1.Items(i).Cells(30).Text)
        txtAux_final.Text = DataGrid1.Items(i).Cells(31).Text
        txtrwfgen_initial.Text = Trim(DataGrid1.Items(i).Cells(32).Text)
        txtrwfgen_final.Text = DataGrid1.Items(i).Cells(33).Text
        txtPCS_initial.Text = Trim(DataGrid1.Items(i).Cells(34).Text)
        txtPCS_final.Text = DataGrid1.Items(i).Cells(35).Text
    End Sub

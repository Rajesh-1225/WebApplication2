...
Public Class login_next_new
    ...
    Public Sub get_menu()
        ...
        Dim conn As SqlConnection = New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=WAP;User Id=crissqlserver;Password=Cris@BelaQwertPoiuy")
        conn.Open()
    ...
    Protected Sub menuBar_MenuItemClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.MenuEventArgs) Handles menuBar.MenuItemClick
        ...
        If e.Item.Text = "WHEEL QCI" Then
            ...
            End If
        End If
        If e.Item.Text = "PCME" Then
            Group = "HAGREP"
            str = check()
            If str = Group Then
                lblaccess.Visible = False
                Session("Group") = "HAGREP"
                Session("Apps") = "MMS"
                Dim url As String = "wapframeset.aspx"
                Dim s As String = "window.open('" & url + "', '_newtab');"
                ClientScript.RegisterStartupScript(Me.GetType(), "script", s, True)
            ...
            End If
        End If
        If e.Item.Text = "DY. CME PLANNING" Then
            Group = "PLGREP"
            str = check()
            If str = Group Then
                lblaccess.Visible = False
                Session("Group") = "PLGREP"
                Session("Apps") = "MMS"
                Dim url As String = "wapframeset.aspx"
                Dim s As String = "window.open('" & url + "', '_newtab');"
                ClientScript.RegisterStartupScript(Me.GetType(), "script", s, True)
            ...
            End If
        End If
        If e.Item.Text = "DY. CME CASTING" Then
            Group = "CASTREP"
            str = check()
            If str = Group Then
                lblaccess.Visible = False
                Session("Group") = "CASTREP"
                Session("Apps") = "MMS"
                Dim url As String = "wapframeset.aspx"
                Dim s As String = "window.open('" & url + "', '_newtab');"
                ClientScript.RegisterStartupScript(Me.GetType(), "script", s, True)
            ...
            End If
        End If
        If e.Item.Text = "DY. CME WFPS" Then
            Group = "WFPSREP"
            str = check()
            If str = Group Then
                lblaccess.Visible = False
                Session("Group") = "WFPSREP"
                Session("Apps") = "MMS"
                Dim url As String = "wapframeset.aspx"
                Dim s As String = "window.open('" & url + "', '_newtab');"
                ClientScript.RegisterStartupScript(Me.GetType(), "script", s, True)
        ...
        If e.Item.Text = "DY. CME MFG" Then
            Group = "MFGREP"
            str = check()
            If str = Group Then
                lblaccess.Visible = False
                Session("Group") = "MFGREP"
                Session("Apps") = "MMS"
                Dim url As String = "wapframeset.aspx"
                Dim s As String = "window.open('" & url + "', '_newtab');"
                ClientScript.RegisterStartupScript(Me.GetType(), "script", s, True)

...
#End Region
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        If RWF.MLDING.CheckMRShiftDetailsDate(CDate(txtDate.Text), rblShift.SelectedItem.Value) Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=40554&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &
    ...
    '    If RWF.MLDING.CheckMRShiftDetailsDate(CDate(txtDate.Text), rblShift.SelectedItem.Value) Then
    '        Dim strPathName As String
    '        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=8157&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &
    ...
    '    If RWF.MLDING.CheckMRShiftDetailsDate(CDate(txtDate.Text), rblShift.SelectedItem.Value) Then
    '        Dim strPathName As String
    '        strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?id=8169&apsuser=Administrator&apspassword=Cris@123&apsauthtype=secEnterprise&user0=crissqlserver&password0=Cris@BelaQwertPoiuy&promptonrefresh=0" &

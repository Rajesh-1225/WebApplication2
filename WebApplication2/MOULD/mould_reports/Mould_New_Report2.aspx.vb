Public Class MouldNewReports2
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=40343&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=34098&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
     "&promptex0=DateTime(" & CDate(Textbox1.Text).Year & "," & CDate(Textbox1.Text).Month & ", " & CDate(Textbox1.Text).Day & ", 0,0,0)" &
            "&promptex1=DateTime(" & CDate(Textbox2.Text).Year & "," & CDate(Textbox2.Text).Month & "," & CDate(Textbox2.Text).Day & ", 0,0,0)"
            Response.Redirect(strPathName)
        End If
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=34105&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
     "&promptex0=DateTime(" & CDate(Textbox1.Text).Year & "," & CDate(Textbox1.Text).Month & ", " & CDate(Textbox1.Text).Day & ", 0,0,0)" &
            "&promptex1=DateTime(" & CDate(Textbox2.Text).Year & "," & CDate(Textbox2.Text).Month & "," & CDate(Textbox2.Text).Day & ", 0,0,0)"
            Response.Redirect(strPathName)
        End If
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=34344&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
      "&promptex0=DateTime(" & CDate(Textbox1.Text).Year & "," & CDate(Textbox1.Text).Month & ", " & CDate(Textbox1.Text).Day & ", 0,0,0)" &
            "&promptex1=DateTime(" & CDate(Textbox2.Text).Year & "," & CDate(Textbox2.Text).Month & "," & CDate(Textbox2.Text).Day & ", 0,0,0)"
            Response.Redirect(strPathName)
        End If
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=40350&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
     "&promptex0=DateTime(" & CDate(Textbox1.Text).Year & "," & CDate(Textbox1.Text).Month & ", " & CDate(Textbox1.Text).Day & ", 0,0,0)" &
            "&promptex1=DateTime(" & CDate(Textbox2.Text).Year & "," & CDate(Textbox2.Text).Month & "," & CDate(Textbox2.Text).Day & ", 0,0,0)"
            Response.Redirect(strPathName)
        End If
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=41351&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
     "&promptex0=DateTime(" & CDate(Textbox1.Text).Year & "," & CDate(Textbox1.Text).Month & ", " & CDate(Textbox1.Text).Day & ", 0,0,0)" &
            "&promptex1=DateTime(" & CDate(Textbox2.Text).Year & "," & CDate(Textbox2.Text).Month & "," & CDate(Textbox2.Text).Day & ", 0,0,0)"
            Response.Redirect(strPathName)
        End If
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=35679&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
     "&promptex0=DateTime(" & CDate(Textbox1.Text).Year & "," & CDate(Textbox1.Text).Month & ", " & CDate(Textbox1.Text).Day & ", 0,0,0)" &
            "&promptex1=DateTime(" & CDate(Textbox2.Text).Year & "," & CDate(Textbox2.Text).Month & "," & CDate(Textbox2.Text).Day & ", 0,0,0)"
            Response.Redirect(strPathName)
        End If
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        If Not Done Then
            ...
            strPathName = "http://rwpbela3.southindia.cloudapp.azure.com:8080/BOE/CMC/1903072256/CrystalReports/viewrpt.cwr?apsuser=Administrator&apspassword=Cris@123&1225&apsauthtype=secEnterprise&id=34083&user0=crissqlserver&password0=Cris@BelaQwertPoiuy" &
     "&promptex0=DateTime(" & CDate(Textbox1.Text).Year & "," & CDate(Textbox1.Text).Month & ", " & CDate(Textbox1.Text).Day & ", 0,0,0)" &
            "&promptex1=DateTime(" & CDate(Textbox2.Text).Year & "," & CDate(Textbox2.Text).Month & "," & CDate(Textbox2.Text).Day & ", 0,0,0)"
            Response.Redirect(strPathName)
        End If

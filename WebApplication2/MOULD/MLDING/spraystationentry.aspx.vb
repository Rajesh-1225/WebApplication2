...
Public Class spraystationentry
    ...
    Public Function f1()
        ...
        Try
            'con.ConnectionString = "Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User ID=crissqlserver;Password=Cris@BelaQwertPoiuy"
            'con.Open()
            'cmd.Connection = con
            cmd.Connection.Open()
    ...
    Private Sub getdatadrag()
        ...
        'Dim con As SqlConnection = New SqlConnection("Data Source=cris-sql.public.a226b58b96ec.database.windows.net,3342;Initial Catalog=wap;User ID=crissqlserver;Password=Cris@BelaQwertPoiuy")
        'con.Open()
        cmd.Connection.Open()

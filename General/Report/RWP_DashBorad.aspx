<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RWP_DashBorad.aspx.vb" Inherits="WebApplication2.RWP_DashBorad" %>
...
<div class="col-md-12">  <br /><br />
    <div style="float:left" >  <span style="font-weight:bold"> WHEEL CATEGORY :</span> <br /> 
        ...
        <a   class="btn btn-primary widgetsbox btn-sm " style="color:white" perd="WHD" id="WHD">WHEEL DISPATCH
 </a> 
